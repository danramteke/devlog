...
Because this potential client was a small Rails shop, they only had time to work on their Rails app. All the mobile work would be done mobile-only developers. When hiring for that role, our client wanted to hire Objective-C programmers because of the perceived larger pool of Objective-C developers compared to the pool of RubyMotion developers. 
